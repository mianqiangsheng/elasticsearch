...
import com.lizhen.elasticsearch.config.EnableReactiveElasticsearchAuditing;
import com.lizhen.elasticsearch.core.event.ReactiveAuditingEntityCallback;
...
class ReactiveElasticsearchAuditingRegistrar extends AuditingBeanDefinitionRegistrarSupport {
	...
	protected BeanDefinitionBuilder getAuditHandlerBeanDefinitionBuilder(AuditingConfiguration configuration) {
		...
		BeanDefinitionBuilder definition = BeanDefinitionBuilder.genericBeanDefinition(com.lizhen.elasticsearch.config.PersistentEntitiesFactoryBean.class);
