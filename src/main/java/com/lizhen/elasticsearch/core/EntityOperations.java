...
class EntityOperations {
	 ...
	 * @deprecated since 4.1, use {@link com.lizhen.elasticsearch.core.EntityOperations#determineIndex(Entity, String)}
	 */
	@Deprecated
	 ...
	 * @param type index type override can be {@literal null}.
	 * @return the {@link IndexCoordinates} containing index name and index type.
	 * @deprecated since 4.1, use {@link com.lizhen.elasticsearch.core.EntityOperations#determineIndex(ElasticsearchPersistentEntity, String)}
	 */
	@Deprecated
	...
	private static class MapBackedEntity<T extends Map<String, Object>> implements AdaptibleEntity<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see com.lizhen.elasticsearch.core.EntityOperations.Entity#getId()
		 */
		@Override
		public Object getId() {
		...
		/*
		 * (non-Javadoc)
		 * @see com.lizhen.elasticsearch.core.EntityOperations.AdaptibleEntity#hasParent()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.lizhen.elasticsearch.core.EntityOperations.AdaptibleEntity#getParentId()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.lizhen.elasticsearch.core.EntityOperations.AdaptibleEntity#populateIdIfNecessary(java.lang.Object)
		 */
		@Nullable
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.lizhen.elasticsearch.core.EntityOperations.AdaptibleEntity#initializeVersionProperty()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.lizhen.elasticsearch.core.EntityOperations.AdaptibleEntity#getVersion()
		 */
		@Override
		@Nullable
		...
		/*
		 * (non-Javadoc)
		 * @see com.lizhen.elasticsearch.core.EntityOperations.AdaptibleEntity#incrementVersion()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.lizhen.elasticsearch.core.EntityOperations.Entity#getBean()
		 */
		@Override
		public T getBean() {
			return map;
		...
		/*
		 * (non-Javadoc)
		 * @see com.lizhen.elasticsearch.core.EntityOperations.Entity#isNew()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.lizhen.elasticsearch.core.EntityOperations.Entity#getPersistentEntity()
		 */
		@Override
	...
	private static class SimpleMappedEntity<T extends Map<String, Object>> extends MapBackedEntity<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see com.lizhen.elasticsearch.core.EntityOperations.UnmappedEntity#getId()
		 */
		@Override
		public Object getId() {
