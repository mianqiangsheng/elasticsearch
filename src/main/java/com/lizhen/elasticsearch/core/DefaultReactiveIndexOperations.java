...
import com.lizhen.elasticsearch.core.ReactiveResourceUtil;
...
import com.lizhen.elasticsearch.core.index.TemplateData;
...
class DefaultReactiveIndexOperations implements ReactiveIndexOperations {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(com.lizhen.elasticsearch.core.DefaultReactiveIndexOperations.class);

	@Nullable private final Class<?> boundClass;
	private final IndexCoordinates boundIndex;
	private final com.lizhen.elasticsearch.core.RequestFactory requestFactory;
	...
	public DefaultReactiveIndexOperations(ReactiveElasticsearchOperations operations, IndexCoordinates index) {
		...
		this.requestFactory = new com.lizhen.elasticsearch.core.RequestFactory(operations.getElasticsearchConverter());
