...
import com.lizhen.elasticsearch.core.ScriptType;
...
public class UpdateQuery {
	...
	public static final class Builder {
		...
		public com.lizhen.elasticsearch.core.query.UpdateQuery build() {

			if (script == null && document == null && query == null) {
				throw new IllegalArgumentException("either script, document or query must be set");
			}

			return new com.lizhen.elasticsearch.core.query.UpdateQuery(id, script, params, document, upsert, lang, routing, scriptedUpsert, docAsUpsert,
