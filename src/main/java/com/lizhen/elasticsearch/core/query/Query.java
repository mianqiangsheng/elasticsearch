...
public interface Query {
	...
	/**
	 * Get a {@link com.lizhen.elasticsearch.core.query.Query} that matches all documents in the index.
	 *
	 * @return new instance of {@link com.lizhen.elasticsearch.core.query.Query}.
	 * @since 3.2
	 * @see QueryBuilders#matchAllQuery()
	 */
	static com.lizhen.elasticsearch.core.query.Query findAll() {
	 ...
	 * @return
	 */
	<T extends com.lizhen.elasticsearch.core.query.Query> T setPageable(Pageable pageable);
	 ...
	 * @return
	 */
	<T extends com.lizhen.elasticsearch.core.query.Query> T addSort(Sort sort);
