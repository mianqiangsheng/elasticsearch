...
import com.lizhen.elasticsearch.core.query.FetchSourceFilter;
...
public class FetchSourceFilterBuilder {
	...
	public com.lizhen.elasticsearch.core.query.FetchSourceFilterBuilder withIncludes(String... includes) {
		this.includes = includes;
		return this;
	}

	public com.lizhen.elasticsearch.core.query.FetchSourceFilterBuilder withExcludes(String... excludes) {
