...
public class IndexedObjectInformation {
	...
	public static com.lizhen.elasticsearch.core.IndexedObjectInformation of(String id, @Nullable Long seqNo, @Nullable Long primaryTerm,
                                                                                          @Nullable Long version) {
		return new com.lizhen.elasticsearch.core.IndexedObjectInformation(id, seqNo, primaryTerm, version);
	}
