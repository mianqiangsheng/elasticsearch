...
import com.lizhen.elasticsearch.core.index.AliasAction;
import com.lizhen.elasticsearch.core.index.AliasActionParameters;
import com.lizhen.elasticsearch.core.index.AliasActions;
import com.lizhen.elasticsearch.core.index.DeleteTemplateRequest;
import com.lizhen.elasticsearch.core.index.ExistsTemplateRequest;
import com.lizhen.elasticsearch.core.index.GetTemplateRequest;
import com.lizhen.elasticsearch.core.index.PutTemplateRequest;
...
import com.lizhen.elasticsearch.core.query.*;
import com.lizhen.elasticsearch.core.query.RescorerQuery.ScoreMode;
...
class RequestFactory {
	...
	public DeleteIndexTemplateRequest deleteIndexTemplateRequest(
	...
	public UpdateRequest updateRequest(UpdateQuery query, IndexCoordinates index) {
		...
		if (query.getRefreshPolicy() != null) {
			updateRequest.setRefreshPolicy(com.lizhen.elasticsearch.core.RequestFactory.toElasticsearchRefreshPolicy(query.getRefreshPolicy()));
		}
	...
	public UpdateRequestBuilder updateRequestBuilderFor(Client client, UpdateQuery query, IndexCoordinates index) {
		...
		if (query.getRefreshPolicy() != null) {
			updateRequestBuilder.setRefreshPolicy(com.lizhen.elasticsearch.core.RequestFactory.toElasticsearchRefreshPolicy(query.getRefreshPolicy()));
		}
	...
	private QueryBuilder getQuery(Query query) {
		...
		if (query instanceof NativeSearchQuery) {
			...
			elasticsearchQuery = new com.lizhen.elasticsearch.core.CriteriaQueryProcessor().createQuery(criteriaQuery.getCriteria());
