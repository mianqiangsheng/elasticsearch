...
/**
 * {@link com.lizhen.elasticsearch.core.geo.GeoJsonMultiPoint} is defined as list of {@link Point}s.<br/>
...
public class GeoJsonMultiPoint implements GeoJson<Iterable<Point>> {
	...
	/**
	 * Creates a new {@link com.lizhen.elasticsearch.core.geo.GeoJsonMultiPoint} for the given {@link Point}s.
	 *
	 * @param points points must not be {@literal null} and have at least 2 entries.
	 */
	public static com.lizhen.elasticsearch.core.geo.GeoJsonMultiPoint of(List<Point> points) {

		Assert.notNull(points, "Points must not be null.");
		Assert.isTrue(points.size() >= 2, "Minimum of 2 Points required.");

		return new com.lizhen.elasticsearch.core.geo.GeoJsonMultiPoint(points);
	}
	 ...
	 */
	public static com.lizhen.elasticsearch.core.geo.GeoJsonMultiPoint of(Point first, Point second, Point... others) {
	...
	/**
	 * Creates a new {@link com.lizhen.elasticsearch.core.geo.GeoJsonMultiPoint} for the given {@link GeoPoint}s.
	 *
	 * @param geoPoints geoPoints must not be {@literal null} and have at least 2 entries.
	 */
	public static com.lizhen.elasticsearch.core.geo.GeoJsonMultiPoint ofGeoPoints(List<GeoPoint> geoPoints) {

		Assert.notNull(geoPoints, "Points must not be null.");
		Assert.isTrue(geoPoints.size() >= 2, "Minimum of 2 Points required.");

		return new com.lizhen.elasticsearch.core.geo.GeoJsonMultiPoint(geoPoints.stream().map(GeoPoint::toPoint).collect(Collectors.toList()));
	}
	 ...
	 * @param others must not be {@literal null}.
	 */
	public static com.lizhen.elasticsearch.core.geo.GeoJsonMultiPoint of(GeoPoint first, GeoPoint second, GeoPoint... others) {
	...
	public boolean equals(Object o) {
		...
		com.lizhen.elasticsearch.core.geo.GeoJsonMultiPoint that = (com.lizhen.elasticsearch.core.geo.GeoJsonMultiPoint) o;
