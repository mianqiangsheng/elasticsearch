...
import com.lizhen.elasticsearch.core.convert.GeoConverters;
...
public interface GeoJson<T extends Iterable<?>> {
	...
	/**
	 * String value representing the type of the {@link com.lizhen.elasticsearch.core.geo.GeoJson} object.
	 *
	 ...
	 * @return the parsed {@link com.lizhen.elasticsearch.core.geo.GeoJson} object
	 * @throws ConversionException on parse erros
	 */
	static com.lizhen.elasticsearch.core.geo.GeoJson<?> of(String json) {
