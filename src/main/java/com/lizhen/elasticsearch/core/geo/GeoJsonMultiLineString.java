...
/**
 * {@link com.lizhen.elasticsearch.core.geo.GeoJsonMultiLineString} is defined as list of {@link GeoJsonLineString}s. <br/>
...
public class GeoJsonMultiLineString implements GeoJson<Iterable<GeoJsonLineString>> {
	...
	/**
	 * Creates new {@link com.lizhen.elasticsearch.core.geo.GeoJsonMultiLineString} for the given {@link GeoJsonLineString}s.
	 *
	 * @param lines must not be {@literal null}.
	 */
	public static com.lizhen.elasticsearch.core.geo.GeoJsonMultiLineString of(List<GeoJsonLineString> lines) {

		Assert.notNull(lines, "Lines for MultiLineString must not be null!");

		return new com.lizhen.elasticsearch.core.geo.GeoJsonMultiLineString(lines);
	}

	/**
	 * Creates new {@link com.lizhen.elasticsearch.core.geo.GeoJsonMultiLineString} for the given {@link Point}s.
	 *
	 * @param lines must not be {@literal null}.
	 */
	public static com.lizhen.elasticsearch.core.geo.GeoJsonMultiLineString of(List<Point>... lines) {
		...
		return new com.lizhen.elasticsearch.core.geo.GeoJsonMultiLineString(geoJsonLineStrings);
	}
	...
	public boolean equals(Object o) {
		...
		com.lizhen.elasticsearch.core.geo.GeoJsonMultiLineString that = (com.lizhen.elasticsearch.core.geo.GeoJsonMultiLineString) o;
