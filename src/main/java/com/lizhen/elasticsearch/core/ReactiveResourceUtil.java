...
import com.lizhen.elasticsearch.ResourceFailureException;
...
public abstract class ReactiveResourceUtil {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(com.lizhen.elasticsearch.core.ReactiveResourceUtil.class);
