...
import com.lizhen.elasticsearch.core.SearchHitsIterator;
	...
	public static Object unwrapSearchHits(@Nullable Object result) {
		...
		if (result instanceof List<?>) {
			return ((List<?>) result).stream() //
					.map(com.lizhen.elasticsearch.core.SearchHitSupport::unwrapSearchHits) //
					.collect(Collectors.toList());
		}

		if (result instanceof Stream<?>) {
			return ((Stream<?>) result).map(com.lizhen.elasticsearch.core.SearchHitSupport::unwrapSearchHits);
		}
		...
		if (result instanceof SearchPage<?>) {
			...
			List<?> content = (List<?>) com.lizhen.elasticsearch.core.SearchHitSupport.unwrapSearchHits(searchPage.getSearchHits());
		...
		if (ReactiveWrappers.isAvailable(ReactiveWrappers.ReactiveLibrary.PROJECT_REACTOR)) {
			...
			if (result instanceof Flux) {
				...
				return flux.map(com.lizhen.elasticsearch.core.SearchHitSupport::unwrapSearchHits);
			}
		}
