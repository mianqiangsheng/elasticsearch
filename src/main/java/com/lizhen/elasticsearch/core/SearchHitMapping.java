...
import com.lizhen.elasticsearch.core.SearchHit;
import com.lizhen.elasticsearch.core.SearchHits;
import com.lizhen.elasticsearch.core.SearchHitsImpl;
import com.lizhen.elasticsearch.core.SearchScrollHits;
import com.lizhen.elasticsearch.core.TotalHitsRelation;
...
import com.lizhen.elasticsearch.core.document.NestedMetaData;
...
class SearchHitMapping<T> {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(com.lizhen.elasticsearch.core.SearchHitMapping.class);
	...
	static <T> com.lizhen.elasticsearch.core.SearchHitMapping<T> mappingFor(Class<T> entityClass, ElasticsearchConverter converter) {
		return new com.lizhen.elasticsearch.core.SearchHitMapping<>(entityClass, converter);
	}
	...
	private Map<String, SearchHits<?>> mapInnerHits(SearchDocument searchDocument) {
		...
		if (documentInnerHits != null && documentInnerHits.size() > 0) {
			...
			com.lizhen.elasticsearch.core.SearchHitMapping<SearchDocument> searchDocumentSearchHitMapping = com.lizhen.elasticsearch.core.SearchHitMapping
