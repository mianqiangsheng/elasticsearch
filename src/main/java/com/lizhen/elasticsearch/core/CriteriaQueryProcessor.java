...
import static com.lizhen.elasticsearch.core.query.Criteria.*;
...
class CriteriaQueryProcessor {
	...
	private QueryBuilder queryForEntries(Criteria criteria) {
		...
		Iterator<CriteriaEntry> it = criteria.getQueryCriteriaEntries().iterator();
		QueryBuilder query;
	...
	@Nullable
	private QueryBuilder queryFor(CriteriaEntry entry, Field field) {
