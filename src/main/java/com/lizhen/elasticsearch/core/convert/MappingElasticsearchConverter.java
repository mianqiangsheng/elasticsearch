...
import com.lizhen.elasticsearch.annotations.ScriptedField;
...
import com.lizhen.elasticsearch.core.convert.ElasticsearchTypeMapper;
...
import com.lizhen.elasticsearch.core.query.CriteriaQuery;
...
public class MappingElasticsearchConverter
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(com.lizhen.elasticsearch.core.convert.MappingElasticsearchConverter.class);
	...
	private void updateCriteria(Criteria criteria, ElasticsearchPersistentEntity<?> persistentEntity) {
		...
		if (property != null && property.getName().equals(name)) {
			...
			com.lizhen.elasticsearch.annotations.Field fieldAnnotation = property
					.findAnnotation(com.lizhen.elasticsearch.annotations.Field.class);
