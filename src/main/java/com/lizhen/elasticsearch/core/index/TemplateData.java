...
public class TemplateData {
	...
	public static final class TemplateDataBuilder {
		...
		public com.lizhen.elasticsearch.core.index.TemplateData build() {
			return new com.lizhen.elasticsearch.core.index.TemplateData(indexPatterns, settings, mapping, aliases, order, version);
		}
	}
}
