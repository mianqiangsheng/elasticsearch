...
final class GeoShapeMappingParameters {
	 ...
	 */
	public static com.lizhen.elasticsearch.core.index.GeoShapeMappingParameters from(@Nullable GeoShapeField annotation) {

		if (annotation == null) {
			return new com.lizhen.elasticsearch.core.index.GeoShapeMappingParameters(false, false, true, GeoShapeField.Orientation.ccw);
		} else {
			return new com.lizhen.elasticsearch.core.index.GeoShapeMappingParameters(annotation.coerce(), annotation.ignoreMalformed(), annotation.ignoreZValue(),
