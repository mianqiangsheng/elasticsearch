...
public class AliasActionParameters {
	...
	public static final class Builder {
		...
		public com.lizhen.elasticsearch.core.index.AliasActionParameters build() {

			Assert.notNull(indices, "indices must be set");

			return new com.lizhen.elasticsearch.core.index.AliasActionParameters(indices, aliases, isHidden, isWriteIndex, routing, indexRouting, searchRouting,
