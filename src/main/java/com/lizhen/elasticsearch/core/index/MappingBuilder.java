...
import static com.lizhen.elasticsearch.core.index.MappingParameters.*;
...
import com.lizhen.elasticsearch.annotations.*;
...
import com.lizhen.elasticsearch.core.index.MappingParameters;
...
public class MappingBuilder {
	...
	private void applyGeoShapeMapping(XContentBuilder builder, ElasticsearchPersistentProperty property)
		...
		com.lizhen.elasticsearch.core.index.GeoShapeMappingParameters.from(property.findAnnotation(GeoShapeField.class)).writeTypeAndParametersTo(builder);
		builder.endObject();
	}
