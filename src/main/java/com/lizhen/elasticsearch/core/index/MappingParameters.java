 ...
 */
package com.lizhen.elasticsearch.core.index;
...
import com.lizhen.elasticsearch.annotations.IndexOptions;
import com.lizhen.elasticsearch.annotations.IndexPrefixes;
import com.lizhen.elasticsearch.annotations.InnerField;
import com.lizhen.elasticsearch.annotations.NullValueType;
import com.lizhen.elasticsearch.annotations.Similarity;
import com.lizhen.elasticsearch.annotations.TermVector;
...
public final class MappingParameters {
	 ...
	 */
	public static com.lizhen.elasticsearch.core.index.MappingParameters from(Annotation annotation) {

		Assert.notNull(annotation, "annotation must not be null!");

		if (annotation instanceof Field) {
			return new com.lizhen.elasticsearch.core.index.MappingParameters((Field) annotation);
		} else if (annotation instanceof InnerField) {
			return new com.lizhen.elasticsearch.core.index.MappingParameters((InnerField) annotation);
		} else {
