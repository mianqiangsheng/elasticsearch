...
public class AliasData {
	...
	public static com.lizhen.elasticsearch.core.index.AliasData of(String alias,
                                                                                 @Nullable Document filter,
                                                                                 @Nullable String indexRouting,
                                                                                 @Nullable String searchRouting,
                                                                                 @Nullable Boolean isWriteIndex,
                                                                                 @Nullable Boolean isHidden) {
		return new com.lizhen.elasticsearch.core.index.AliasData(alias, filter, indexRouting, searchRouting, isWriteIndex, isHidden);
	}
