...
public class PutTemplateRequest {
	...
	public static final class TemplateRequestBuilder {
		...
		public com.lizhen.elasticsearch.core.index.PutTemplateRequest build() {
			return new com.lizhen.elasticsearch.core.index.PutTemplateRequest(name, indexPatterns, settings, mappings, aliasActions, order, version);
		}
	}
}
