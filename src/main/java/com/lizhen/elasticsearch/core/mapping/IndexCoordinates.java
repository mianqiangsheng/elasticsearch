...
public class IndexCoordinates {
	...
	public static com.lizhen.elasticsearch.core.mapping.IndexCoordinates of(String... indexNames) {
		Assert.notNull(indexNames, "indexNames must not be null");
		return new com.lizhen.elasticsearch.core.mapping.IndexCoordinates(indexNames);
	}
	...
	public boolean equals(Object o) {
		...
		com.lizhen.elasticsearch.core.mapping.IndexCoordinates that = (com.lizhen.elasticsearch.core.mapping.IndexCoordinates) o;
