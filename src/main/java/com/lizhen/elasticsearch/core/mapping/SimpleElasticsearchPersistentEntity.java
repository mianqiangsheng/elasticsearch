...
import com.lizhen.elasticsearch.annotations.Routing;
import com.lizhen.elasticsearch.annotations.Setting;
...
public class SimpleElasticsearchPersistentEntity<T> extends BasicPersistentEntity<T, ElasticsearchPersistentProperty>
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(com.lizhen.elasticsearch.core.mapping.SimpleElasticsearchPersistentEntity.class);
	...
	public SimpleElasticsearchPersistentEntity(TypeInformation<T> typeInformation) {
		...
		Document document = AnnotatedElementUtils
				.findMergedAnnotation(clazz, Document.class);
