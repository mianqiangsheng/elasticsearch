...
import com.lizhen.elasticsearch.core.IndexedObjectInformation;
...
import com.lizhen.elasticsearch.NoSuchIndexException;
...
import com.lizhen.elasticsearch.core.EntityOperations.AdaptibleEntity;
...
import com.lizhen.elasticsearch.core.event.ReactiveAfterConvertCallback;
import com.lizhen.elasticsearch.core.event.ReactiveAfterSaveCallback;
import com.lizhen.elasticsearch.core.event.ReactiveBeforeConvertCallback;
...
import com.lizhen.elasticsearch.core.query.UpdateResponse;
...
public class ReactiveElasticsearchTemplate implements ReactiveElasticsearchOperations, ApplicationContextAware {
	...
	private static final Logger QUERY_LOGGER = LoggerFactory
			.getLogger("com.lizhen.elasticsearch.core.QUERY");
	...
	private com.lizhen.elasticsearch.core.ReactiveElasticsearchTemplate copy() {

		com.lizhen.elasticsearch.core.ReactiveElasticsearchTemplate copy = new com.lizhen.elasticsearch.core.ReactiveElasticsearchTemplate(client, converter);
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.core.ReactiveDElasticsearchOperations#index(Object, IndexCoordinates)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.core.ReactiveElasticsearchOperations#delete(Object, String, String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.core.ReactiveElasticsearchOperations#delete(Query, Class, IndexCoordinates)
	 */
	@Override
	...
	public ReactiveElasticsearchOperations withRouting(RoutingResolver routingResolver) {
		...
		com.lizhen.elasticsearch.core.ReactiveElasticsearchTemplate copy = copy();
		copy.setRoutingResolver(routingResolver);
		return copy;
	}
	// endregion
	...
	private class Entities<T> {
		...
		private List<IndexQuery> indexQueries() {
			return entities.stream().map(com.lizhen.elasticsearch.core.ReactiveElasticsearchTemplate.this::getIndexQuery).collect(Collectors.toList());
		}
