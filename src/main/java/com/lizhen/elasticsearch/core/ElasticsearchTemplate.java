...
import com.lizhen.elasticsearch.support.SearchHitsUtil;
...
public class ElasticsearchTemplate extends AbstractElasticsearchTemplate {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(com.lizhen.elasticsearch.core.ElasticsearchTemplate.class);
	...
	protected AbstractElasticsearchTemplate doCopy() {
		com.lizhen.elasticsearch.core.ElasticsearchTemplate elasticsearchTemplate = new com.lizhen.elasticsearch.core.ElasticsearchTemplate(client, elasticsearchConverter);
	...
	public IndexOperations indexOps(Class<?> clazz) {
		...
		return new com.lizhen.elasticsearch.core.DefaultTransportIndexOperations(client, elasticsearchConverter, clazz);
	}
	...
	public IndexOperations indexOps(IndexCoordinates index) {
		...
		return new com.lizhen.elasticsearch.core.DefaultTransportIndexOperations(client, elasticsearchConverter, index);
	}
	// endregion
