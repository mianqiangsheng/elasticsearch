 ...
 */
package com.lizhen.elasticsearch.support;
...
public final class VersionInfo {
	...
	private static final Logger LOG = LoggerFactory.getLogger(com.lizhen.elasticsearch.support.VersionInfo.class);
	...
	public static void logVersions(@Nullable String clusterVersion) {
		if (!initialized.getAndSet(true)) {
			try {
				InputStream resource = com.lizhen.elasticsearch.support.VersionInfo.class.getClassLoader().getResourceAsStream(VERSION_PROPERTIES);
				if (resource != null) {
