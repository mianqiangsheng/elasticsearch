...
/**
 * Utility class for common access to Elasticsearch clients. {@link com.lizhen.elasticsearch.client.RestClients} consolidates set up routines for the
...
public final class RestClients {
	 ...
	 */
	private static final String LOG_ID_ATTRIBUTE = com.lizhen.elasticsearch.client.RestClients.class.getName() + ".LOG_ID";
	...
	private static class HttpLoggingInterceptor implements HttpResponseInterceptor, HttpRequestInterceptor {
		...
		public void process(HttpRequest request, HttpContext context) throws IOException {
			...
			String logId = (String) context.getAttribute(com.lizhen.elasticsearch.client.RestClients.LOG_ID_ATTRIBUTE);

			if (logId == null) {
				logId = ClientLogger.newLogId();
				context.setAttribute(com.lizhen.elasticsearch.client.RestClients.LOG_ID_ATTRIBUTE, logId);
			}
