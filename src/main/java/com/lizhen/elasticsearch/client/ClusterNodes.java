...
class ClusterNodes implements Streamable<TransportAddress> {
	...
	public static com.lizhen.elasticsearch.client.ClusterNodes DEFAULT = com.lizhen.elasticsearch.client.ClusterNodes.of("127.0.0.1:9300");
	...
	/**
	 * Creates a new {@link com.lizhen.elasticsearch.client.ClusterNodes} by parsing the given source.
	 * 
	...
	/**
	 * Creates a new {@link com.lizhen.elasticsearch.client.ClusterNodes} by parsing the given source. The expected format is a comma separated list of
	 * host-port-combinations separated by a colon: {@code host:port,host:port,…}.
	 * 
	 * @param source must not be {@literal null} or empty.
	 * @return
	 */
	public static com.lizhen.elasticsearch.client.ClusterNodes of(String source) {
		return new com.lizhen.elasticsearch.client.ClusterNodes(source);
	}
