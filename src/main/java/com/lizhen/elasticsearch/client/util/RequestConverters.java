 ...
 */
package com.lizhen.elasticsearch.client.util;
...
public class RequestConverters {
	...
	public static Request indexDelete(DeleteIndexRequest deleteIndexRequest) {
		String endpoint = com.lizhen.elasticsearch.client.util.RequestConverters.endpoint(deleteIndexRequest.indices());
		Request request = new Request(HttpMethod.DELETE.name(), endpoint);

		com.lizhen.elasticsearch.client.util.RequestConverters.Params parameters = new com.lizhen.elasticsearch.client.util.RequestConverters.Params(request);
	...
	public static Request indexOpen(OpenIndexRequest openIndexRequest) {
		String endpoint = com.lizhen.elasticsearch.client.util.RequestConverters.endpoint(openIndexRequest.indices(), "_open");
		Request request = new Request(HttpMethod.POST.name(), endpoint);
	...
	public static Request indexClose(CloseIndexRequest closeIndexRequest) {
		String endpoint = com.lizhen.elasticsearch.client.util.RequestConverters.endpoint(closeIndexRequest.indices(), "_close");
		Request request = new Request(HttpMethod.POST.name(), endpoint);
	...
	public static Request indexCreate(CreateIndexRequest createIndexRequest) {
		String endpoint = com.lizhen.elasticsearch.client.util.RequestConverters.endpoint(createIndexRequest.indices());
		...
		request.setEntity(createEntity(createIndexRequest, com.lizhen.elasticsearch.client.util.RequestConverters.REQUEST_BODY_CONTENT_TYPE));
		return request;
	}

	public static Request indexCreate(org.elasticsearch.client.indices.CreateIndexRequest createIndexRequest) {
		String endpoint = com.lizhen.elasticsearch.client.util.RequestConverters.endpoint(new String[] { createIndexRequest.index() });
		Request request = new Request(HttpMethod.PUT.name(), endpoint);
	...
	public static Request indexRefresh(RefreshRequest refreshRequest) {
		...
		Request request = new Request(HttpMethod.GET.name(), com.lizhen.elasticsearch.client.util.RequestConverters.endpoint(indices, "_refresh"));
	...
	public static Request putMapping(PutMappingRequest putMappingRequest) {
		...
		Request request = new Request(HttpMethod.PUT.name(),
				com.lizhen.elasticsearch.client.util.RequestConverters.endpoint(putMappingRequest.indices(), "_mapping"));

		com.lizhen.elasticsearch.client.util.RequestConverters.Params parameters = new com.lizhen.elasticsearch.client.util.RequestConverters.Params(request) //
				.withTimeout(putMappingRequest.timeout()) //
				.withMasterTimeout(putMappingRequest.masterNodeTimeout()) //
				.withIncludeTypeName(false);
		request.setEntity(com.lizhen.elasticsearch.client.util.RequestConverters.createEntity(putMappingRequest, com.lizhen.elasticsearch.client.util.RequestConverters.REQUEST_BODY_CONTENT_TYPE));
		return request;
	}
	...
	public static Request putMapping(org.elasticsearch.client.indices.PutMappingRequest putMappingRequest) {
		...
		new com.lizhen.elasticsearch.client.util.RequestConverters.Params(request) //
				.withTimeout(putMappingRequest.timeout()) //
				.withMasterTimeout(putMappingRequest.masterNodeTimeout()) //
				.withIncludeTypeName(false);
		request.setEntity(com.lizhen.elasticsearch.client.util.RequestConverters.createEntity(putMappingRequest, com.lizhen.elasticsearch.client.util.RequestConverters.REQUEST_BODY_CONTENT_TYPE));
	...
	public static Request flushIndex(FlushRequest flushRequest) {
		...
		Request request = new Request(HttpMethod.POST.name(), com.lizhen.elasticsearch.client.util.RequestConverters.endpoint(indices, "_flush"));
	...
	public static Request getMapping(GetMappingsRequest getMappingsRequest) {
		...
		Request request = new Request(HttpMethod.GET.name(), com.lizhen.elasticsearch.client.util.RequestConverters.endpoint(indices, "_mapping", types));
	...
	public static Request getMapping(org.elasticsearch.client.indices.GetMappingsRequest getMappingsRequest) {
		...
		Request request = new Request(HttpMethod.GET.name(), com.lizhen.elasticsearch.client.util.RequestConverters.endpoint(indices, "_mapping"));
	...
	public static Request getSettings(GetSettingsRequest getSettingsRequest) {
		...
		Request request = new Request(HttpMethod.GET.name(), com.lizhen.elasticsearch.client.util.RequestConverters.endpoint(indices, "_settings", names));
	...
	public static Request updateAliases(IndicesAliasesRequest indicesAliasesRequest) {
		...
		request
				.setEntity(com.lizhen.elasticsearch.client.util.RequestConverters.createEntity(indicesAliasesRequest, com.lizhen.elasticsearch.client.util.RequestConverters.REQUEST_BODY_CONTENT_TYPE));
		return request;
	}
	...
	public static Request getAlias(GetAliasesRequest getAliasesRequest) {
		...
		String endpoint = com.lizhen.elasticsearch.client.util.RequestConverters.endpoint(indices, "_alias", aliases);

		Request request = new Request(HttpGet.METHOD_NAME, endpoint);

		com.lizhen.elasticsearch.client.util.RequestConverters.Params params = new com.lizhen.elasticsearch.client.util.RequestConverters.Params(request);
	...
	public static Request putTemplate(PutIndexTemplateRequest putIndexTemplateRequest) {
		String endpoint = (new com.lizhen.elasticsearch.client.util.RequestConverters.EndpointBuilder()) //
		...
		request.setEntity(
				com.lizhen.elasticsearch.client.util.RequestConverters.createEntity(putIndexTemplateRequest, com.lizhen.elasticsearch.client.util.RequestConverters.REQUEST_BODY_CONTENT_TYPE));
		return request;
	}

	public static Request getTemplates(GetIndexTemplatesRequest getIndexTemplatesRequest) {
		final String endpoint = new com.lizhen.elasticsearch.client.util.RequestConverters.EndpointBuilder().addPathPartAsIs("_template")
	...
	public static Request templatesExist(IndexTemplatesExistRequest indexTemplatesExistRequest) {
		...
		final com.lizhen.elasticsearch.client.util.RequestConverters.Params params = new com.lizhen.elasticsearch.client.util.RequestConverters.Params(request);
	...
	public static Request deleteTemplate(DeleteIndexTemplateRequest deleteIndexTemplateRequest) {
		...
		String endpoint = new com.lizhen.elasticsearch.client.util.RequestConverters.EndpointBuilder().addPathPartAsIs("_template").addPathPart(name).build();
	...
	public static Request getFieldMapping(GetFieldMappingsRequest getFieldMappingsRequest) {
		...
		com.lizhen.elasticsearch.client.util.RequestConverters.Params parameters = new Params(request);
