...
public class ElasticsearchHost {
	 ...
	 * @return new instance of {@link com.lizhen.elasticsearch.client.ElasticsearchHost}.
	 */
	public static com.lizhen.elasticsearch.client.ElasticsearchHost online(InetSocketAddress host) {
		return new com.lizhen.elasticsearch.client.ElasticsearchHost(host, State.ONLINE);
	}
	 ...
	 * @return new instance of {@link com.lizhen.elasticsearch.client.ElasticsearchHost}.
	 */
	public static com.lizhen.elasticsearch.client.ElasticsearchHost offline(InetSocketAddress host) {
		return new com.lizhen.elasticsearch.client.ElasticsearchHost(host, State.OFFLINE);
	}
	...
	public static InetSocketAddress parse(String hostAndPort) {
		return com.lizhen.elasticsearch.client.InetSocketAddressParser.parse(hostAndPort, DEFAULT_PORT);
	}
