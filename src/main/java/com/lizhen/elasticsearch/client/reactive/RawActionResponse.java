...
class RawActionResponse extends ActionResponse {
	...
	static com.lizhen.elasticsearch.client.reactive.RawActionResponse create(ClientResponse response) {
		return new com.lizhen.elasticsearch.client.reactive.RawActionResponse(response);
	}
