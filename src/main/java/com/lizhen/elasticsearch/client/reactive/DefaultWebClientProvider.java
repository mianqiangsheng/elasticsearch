...
class DefaultWebClientProvider implements WebClientProvider {
	...
	/**
	 * Create new {@link com.lizhen.elasticsearch.client.reactive.DefaultWebClientProvider} with empty {@link HttpHeaders} and no-op {@literal error listener}.
	 *
	...
	public WebClientProvider withDefaultHeaders(HttpHeaders headers) {
		...
		return new com.lizhen.elasticsearch.client.reactive.DefaultWebClientProvider(scheme, connector, errorListener, merged, pathPrefix, webClientConfigurer);
	}
	...
	public WebClientProvider withErrorListener(Consumer<Throwable> errorListener) {
		...
		return new com.lizhen.elasticsearch.client.reactive.DefaultWebClientProvider(scheme, this.connector, listener, headers, pathPrefix, webClientConfigurer);
	}
	...
	public WebClientProvider withPathPrefix(String pathPrefix) {
		...
		return new com.lizhen.elasticsearch.client.reactive.DefaultWebClientProvider(this.scheme, this.connector, this.errorListener, this.headers, pathPrefix,
				webClientConfigurer);
	}

	@Override
	public WebClientProvider withWebClientConfigurer(Function<WebClient, WebClient> webClientConfigurer) {
		return new com.lizhen.elasticsearch.client.reactive.DefaultWebClientProvider(scheme, connector, errorListener, headers, pathPrefix, webClientConfigurer);
