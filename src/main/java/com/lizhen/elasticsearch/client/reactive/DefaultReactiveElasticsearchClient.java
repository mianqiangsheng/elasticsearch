...
import com.lizhen.elasticsearch.client.reactive.ReactiveRestClients;
...
import com.lizhen.elasticsearch.client.ClientLogger;
import com.lizhen.elasticsearch.client.ElasticsearchHost;
import com.lizhen.elasticsearch.client.NoReachableHostException;
import com.lizhen.elasticsearch.client.reactive.HostProvider.Verification;
import com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient.Indices;
import com.lizhen.elasticsearch.client.util.NamedXContents;
import com.lizhen.elasticsearch.client.util.ScrollState;
...
public class DefaultReactiveElasticsearchClient implements ReactiveElasticsearchClient, Indices {
	...
	/**
	 * Create a new {@link com.lizhen.elasticsearch.client.reactive.DefaultReactiveElasticsearchClient} using the given {@link HostProvider} to obtain server
	 * connections.
	 *
	...
	/**
	 * Create a new {@link com.lizhen.elasticsearch.client.reactive.DefaultReactiveElasticsearchClient} aware of the given nodes in the cluster. <br />
	 ...
	 * @return new instance of {@link com.lizhen.elasticsearch.client.reactive.DefaultReactiveElasticsearchClient}.
	 */
	...
	/**
	 * Create a new {@link com.lizhen.elasticsearch.client.reactive.DefaultReactiveElasticsearchClient} given {@link ClientConfiguration}. <br />
	 * <strong>NOTE</strong> If the cluster requires authentication be sure to provide the according {@link HttpHeaders}
	 * correctly.
	 *
	...
	/**
	 * Create a new {@link com.lizhen.elasticsearch.client.reactive.DefaultReactiveElasticsearchClient} given {@link ClientConfiguration} and
	...
	public static ReactiveElasticsearchClient create(ClientConfiguration clientConfiguration,
		...
		com.lizhen.elasticsearch.client.reactive.DefaultReactiveElasticsearchClient client = new com.lizhen.elasticsearch.client.reactive.DefaultReactiveElasticsearchClient(hostProvider, requestCreator);
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#ping(org.springframework.http.HttpHeaders)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#info(org.springframework.http.HttpHeaders)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#get(org.springframework.http.HttpHeaders, org.elasticsearch.action.get.GetRequest)
	 */
	@Override
	public Mono<GetResult> get(HttpHeaders headers, GetRequest getRequest) {
		...
		return sendRequest(getRequest, requestCreator.get(), GetResponse.class, headers) //
				...
				.map(com.lizhen.elasticsearch.client.reactive.DefaultReactiveElasticsearchClient::getResponseToGetResult) //
				.next();
	}
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#exists(org.springframework.http.HttpHeaders, org.elasticsearch.action.get.GetRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#ping(org.springframework.http.HttpHeaders, org.elasticsearch.action.index.IndexRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#indices()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#ping(org.springframework.http.HttpHeaders, org.elasticsearch.action.update.UpdateRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#ping(org.springframework.http.HttpHeaders, org.elasticsearch.action.delete.DeleteRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#count(org.springframework.http.HttpHeaders, org.elasticsearch.action.search.SearchRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#ping(org.springframework.http.HttpHeaders, org.elasticsearch.action.search.SearchRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#aggregate(org.springframework.http.HttpHeaders, org.elasticsearch.action.search.SearchRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#scroll(org.springframework.http.HttpHeaders, org.elasticsearch.action.search.SearchRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#ping(org.springframework.http.HttpHeaders, org.elasticsearch.index.reindex.DeleteByQueryRequest)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient#bulk(org.springframework.http.HttpHeaders, org.elasticsearch.action.bulk.BulkRequest)
	 */
	@Override
	...
	static class ClientStatus implements Status {
		...
		/*
		 * (non-Javadoc)
		 * @see com.lizhen.elasticsearch.client.reactive.ReactiveElasticsearchClient.Status#hosts()
		 */
		@Override
