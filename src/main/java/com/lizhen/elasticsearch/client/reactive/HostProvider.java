 ...
 * @since 3.2
 */
public interface HostProvider<T extends com.lizhen.elasticsearch.client.reactive.HostProvider<T>> {

	/**
	 * Create a new {@link com.lizhen.elasticsearch.client.reactive.HostProvider} best suited for the given {@link WebClientProvider} and number of hosts.
	 *
	 ...
	 * @return new instance of {@link com.lizhen.elasticsearch.client.reactive.HostProvider}.
	 */
	static com.lizhen.elasticsearch.client.reactive.HostProvider<?> provider(WebClientProvider clientProvider, Supplier<HttpHeaders> headersSupplier,
