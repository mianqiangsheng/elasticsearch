...
import com.lizhen.elasticsearch.client.ClientConfigurationBuilder;
...
public interface ClientConfiguration {
	...
	/**
	 * Creates a new {@link com.lizhen.elasticsearch.client.ClientConfiguration} instance configured to localhost.
	 * <p/>
	 *
	 * <pre class="code">
	 * // "localhost:9200"
	 ...
	 * </pre>
	 *
	 * @return a new {@link com.lizhen.elasticsearch.client.ClientConfiguration} instance
	 * @see ClientConfigurationBuilder#connectedToLocalhost()
	 */
	static com.lizhen.elasticsearch.client.ClientConfiguration localhost() {
		return new ClientConfigurationBuilder().connectedToLocalhost().build();
	}

	/**
	 * Creates a new {@link com.lizhen.elasticsearch.client.ClientConfiguration} instance configured to a single host given {@code hostAndPort}.
	 * <p/>
	 ...
	 * @return a new {@link ClientConfigurationBuilder} instance.
	 */
	static com.lizhen.elasticsearch.client.ClientConfiguration create(String hostAndPort) {
		return new ClientConfigurationBuilder().connectedTo(hostAndPort).build();
	}

	/**
	 * Creates a new {@link com.lizhen.elasticsearch.client.ClientConfiguration} instance configured to a single host given {@link InetSocketAddress}.
	 * <p/>
	 * For example given the endpoint http://localhost:9200
	 *
	 * <pre class="code">
	 ...
	 * @return a new {@link ClientConfigurationBuilder} instance.
	 */
	static com.lizhen.elasticsearch.client.ClientConfiguration create(InetSocketAddress socketAddress) {
	...
	interface TerminalClientConfigurationBuilder {
		...
		/**
		 * Build the {@link com.lizhen.elasticsearch.client.ClientConfiguration} object.
		 *
		 * @return the {@link com.lizhen.elasticsearch.client.ClientConfiguration} object.
		 */
		com.lizhen.elasticsearch.client.ClientConfiguration build();
	}
}
