...
public class TransportClientFactoryBean implements FactoryBean<TransportClient>, InitializingBean, DisposableBean {
	...
	private static final Logger logger = LoggerFactory.getLogger(com.lizhen.elasticsearch.client.TransportClientFactoryBean.class);
	private com.lizhen.elasticsearch.client.ClusterNodes clusterNodes = com.lizhen.elasticsearch.client.ClusterNodes.of("127.0.0.1:9300");
	...
	public void setClusterNodes(String clusterNodes) {
		this.clusterNodes = com.lizhen.elasticsearch.client.ClusterNodes.of(clusterNodes);
	}
