 ...
 */
package com.lizhen.elasticsearch.client;
...
import com.lizhen.elasticsearch.client.ClientConfiguration.ClientConfigurationBuilderWithRequiredEndpoint;
import com.lizhen.elasticsearch.client.ClientConfiguration.MaybeSecureClientConfigurationBuilder;
import com.lizhen.elasticsearch.client.ClientConfiguration.TerminalClientConfigurationBuilder;
...
class ClientConfigurationBuilder
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.ClientConfiguration.ClientConfigurationBuilderWithRequiredEndpoint#connectedTo(java.lang.String[])
	 */
	@Override
	public MaybeSecureClientConfigurationBuilder connectedTo(String... hostAndPorts) {
		...
		this.hosts.addAll(Arrays.stream(hostAndPorts).map(com.lizhen.elasticsearch.client.ClientConfigurationBuilder::parse).collect(Collectors.toList()));
		return this;
	}

	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.ClientConfiguration.ClientConfigurationBuilderWithRequiredEndpoint#connectedTo(java.net.InetSocketAddress[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.ClientConfiguration.MaybeSecureClientConfigurationBuilder#usingSsl()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.ClientConfiguration.MaybeSecureClientConfigurationBuilder#usingSsl(javax.net.ssl.SSLContext)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.ClientConfiguration.MaybeSecureClientConfigurationBuilder#usingSsl(javax.net.ssl.SSLContext, javax.net.ssl.HostnameVerifier)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.ClientConfiguration.TerminalClientConfigurationBuilder#withDefaultHeaders(org.springframework.http.HttpHeaders)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.ClientConfiguration.TerminalClientConfigurationBuilder#withConnectTimeout(java.time.Duration)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.ClientConfiguration.TerminalClientConfigurationBuilder#withTimeout(java.time.Duration)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.lizhen.elasticsearch.client.ClientConfiguration.ClientConfigurationBuilderWithOptionalDefaultHeaders#build()
	 */
	@Override
	public ClientConfiguration build() {
		...
		return new com.lizhen.elasticsearch.client.DefaultClientConfiguration(hosts, headers, useSsl, sslContext, soTimeout, connectTimeout, pathPrefix,
				hostnameVerifier, proxy, webClientConfigurer, httpClientConfigurer, headersSupplier);
	}

	private static InetSocketAddress parse(String hostAndPort) {
		return com.lizhen.elasticsearch.client.InetSocketAddressParser.parse(hostAndPort, ElasticsearchHost.DEFAULT_PORT);
	}
