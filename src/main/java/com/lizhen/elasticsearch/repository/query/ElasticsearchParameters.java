...
import com.lizhen.elasticsearch.repository.query.ElasticsearchParameters.ElasticsearchParameter;
 ...
 * @since 3.2
 */
public class ElasticsearchParameters extends Parameters<com.lizhen.elasticsearch.repository.query.ElasticsearchParameters, ElasticsearchParameter> {
	...
	@Override
	protected com.lizhen.elasticsearch.repository.query.ElasticsearchParameters createFrom(List<ElasticsearchParameter> parameters) {
		return new com.lizhen.elasticsearch.repository.query.ElasticsearchParameters(parameters);
	}
