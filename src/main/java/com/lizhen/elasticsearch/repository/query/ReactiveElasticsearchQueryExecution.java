...
public interface ReactiveElasticsearchQueryExecution {
	...
	/**
	 * An {@link com.lizhen.elasticsearch.repository.query.ReactiveElasticsearchQueryExecution} that wraps the results of the given delegate with the given result
	 * processing.
	 */
	final class ResultProcessingExecution implements com.lizhen.elasticsearch.repository.query.ReactiveElasticsearchQueryExecution {

		private final com.lizhen.elasticsearch.repository.query.ReactiveElasticsearchQueryExecution delegate;
		private final Converter<Object, Object> converter;

		public ResultProcessingExecution(com.lizhen.elasticsearch.repository.query.ReactiveElasticsearchQueryExecution delegate,
