...
import com.lizhen.elasticsearch.repository.query.ConvertingParameterAccessor;
import com.lizhen.elasticsearch.repository.query.ElasticsearchParameterAccessor;
import com.lizhen.elasticsearch.repository.query.ReactiveElasticsearchQueryExecution;
...
import com.lizhen.elasticsearch.repository.query.ReactiveElasticsearchQueryExecution.ResultProcessingConverter;
import com.lizhen.elasticsearch.repository.query.ReactiveElasticsearchQueryExecution.ResultProcessingExecution;
...
abstract class AbstractReactiveElasticsearchRepositoryQuery implements RepositoryQuery {
	...
	public Object execute(Object[] parameters) {
		...
		Object result = queryMethod.hasReactiveWrapperParameter() ? executeDeferred(parameters)
				: execute(new com.lizhen.elasticsearch.repository.query.ReactiveElasticsearchParametersParameterAccessor(queryMethod, parameters));
		return queryMethod.isNotSearchHitMethod() ? SearchHitSupport.unwrapSearchHits(result) : result;
	}

	private Object executeDeferred(Object[] parameters) {

		com.lizhen.elasticsearch.repository.query.ReactiveElasticsearchParametersParameterAccessor parameterAccessor = new com.lizhen.elasticsearch.repository.query.ReactiveElasticsearchParametersParameterAccessor(
