 ...
 */
package com.lizhen.elasticsearch.repository.config;
...
import com.lizhen.elasticsearch.repository.support.ReactiveElasticsearchRepositoryFactoryBean;
...
@Documented
@Inherited
@Import(com.lizhen.elasticsearch.repository.config.ReactiveElasticsearchRepositoriesRegistrar.class)
public @interface EnableReactiveElasticsearchRepositories {
	...
	/**
	 * Configures the name of the {@link com.lizhen.elasticsearch.core.ReactiveElasticsearchOperations} bean
