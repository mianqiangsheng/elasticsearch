 ...
 */
package com.lizhen.elasticsearch.mapping;

import com.lizhen.elasticsearch.index.Settings;
...
public interface ElasticsearchPersistentEntity<T> extends PersistentEntity<T, ElasticsearchPersistentProperty> {
	...
	/**
	 * returns the {@link ElasticsearchPersistentProperty} with the given fieldName (may be set by the {@link com.lizhen.elasticsearch.annotations.Field}
	 * annotation.
	 *
	...
	/**
	 * Returns whether the {@link ElasticsearchPersistentEntity} has a {@link com.lizhen.elasticsearch.join.JoinField} property. If this call returns
	...
	/**
	 * Returns the {@link com.lizhen.elasticsearch.join.JoinField} property of the {@link ElasticsearchPersistentEntity}. Can be {@literal null} in case
	 * no such property is available on the entity.
	 *
	 * @return the {@link com.lizhen.elasticsearch.join.JoinField} {@link ElasticsearchPersistentProperty} of the {@link PersistentEntity} or
	 *         {@literal null} if not defined.
	 * @since 4.1
	 */
	@Nullable
